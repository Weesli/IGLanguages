...
public enum LangEnum {
    ...
    /**
     * Retorna um Optional com o LangEnum correspondente ao código, se existir.
     */
    public static Optional<LangEnum> fromCode(String code) {
        for (LangEnum lang : values()) {
    ...
    /**
     * Verifica se o código informado é válido (existe no Enum).
     */
